package com.company;
//Josh Titens, Ryan Xie
//-	Import Scanner
// create file
//- file needs to be 20 lines of 20 int, doublesand words for each line (400) token total
...
//              per question and add them to mkae a final score at the end
// -  when the user is finished playing calculte their score out of the times they guessed
...
public class FinalProject {
    public static void main(String[] args) throws FileNotFoundException //make sure to have throws
    {
        ...
        do {
            File File = new File("/Users/joshuatitens/IdeaProjects/Summer2020/src/com/company/File.txt");
